...
# IMPORTANTE --> Para ejecutar un codigo en R puedes: (1) poner el cursor sobre el código y apretar Ctrl + Enter; (2) seleccionar el código y hacer clik en "Run"
...
#TOP 5 en base a puntuación general 
datos_fifa %>% 
...
#.....Chile TOP5 en base a puntuación
datos_fifa %>% 
...
# Veamos algunos gráficos generales combinando manipulación y visualizacion
...
(graf_col_chile <- datos_fifa %>% 
  ...
  labs(title= "Puntaje promedio por país en FIFA 2020",
...
(fifa_1 <- datos_fifa %>% 
  ...
  labs(title = "Relación entre la potencia del disparo, la capacidad de finiquito en ataque y el pie dominante",
       subtitle = "Jugadores con valoración (overall) mayor > 85 en FIFA 2020")
)
